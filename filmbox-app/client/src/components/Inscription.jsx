  ...
  return (
    ...
    >
      ...
      <div className="wrapper">
        <div
          className="d-flex flex-column rounded-2 mx-auto"
          style={{
            width: "110%",
        ...
        >
          ...
          >
            ...
            <div
              className="input-box"
              style={{ gridColumn: "1/2", width: "100%", marginTop: "2rem" }}
            >
              <p style={{ fontSize: "22px" }}>First Name:</p>
              <input
                className="w-100 p-2 pe-5 ps-3 text-white border-1 rounded-4 "
                type="text"
                ...
                style={{
                  border: "solid #7465F7",
                  backgroundColor: "rgba(116, 101, 247, 0.1)",
                  outline: "none",
                  /* JE GARDE OU PAS? */ backgroundImage: `url(${cadenas})`,
            ...
            <div
              className="input-box"
              style={{ gridColumn: "2/3", width: "100%", marginTop: "2rem" }}
            >
            ...
            {/* Email / telephone */}{" "}
            {/* BTW : input className= 'p-2 pe-5' OU 'p-2 pe-5 ps-3'*/}
            <div
              className="input-box"
              style={{ gridColumn: "1/2", width: "100%", marginTop: "4rem" }}
            >
              <p style={{ fontSize: "22px" }}>Email:</p>
              <input
                className="w-100 p-2 pe-5 ps-3 text-white border-1 rounded-4 "
                type="text"
                placeholder="Ex: marietremblay@gmail.com"
                required
                value={email}
            ...
            <div
              className="input-box"
              style={{ gridColumn: "2/3", width: "100%", marginTop: "4rem" }}
            >
              <p style={{ fontSize: "22px" }}>Phone Number:</p>
              <input
                className="w-100 p-2 pe-5 ps-3 text-white border-1 rounded-4 "
                type="text"
                placeholder="Ex: 514-123-5678"
                required
                value={phoneNumber}
      ...
      <div className="LoginLink">
        ...
        <Link to="/connexion">
          <button
            type="submit"
            className="btn btn-outline-primary" /*className="nav-link active text-white"*/
          >
            LOGIN
          </button>
        </Link>
